...
impl<'a, 'b, P: swc_ecma_visit::Fold> PassBuilder<'a, 'b, P> {
        ...
        P: 'cmt,
    {
        ...
        //     Some(ModuleConfig::CommonJs(ref c)) => (true, c.import_interop(),
        // c.ignore_dynamic),     Some(ModuleConfig::Amd(ref c)) => {
        ...
        // compat
        // let _compat_pass = if let Some(env) = self.env {
        ...
        // static_blocks_mark: Mark::new(),                         pure_getter:
        ...
        //                         loose: self.loose
        //                     },
        //                     spread: compat::es2015::spread::Config { loose:
        // self.loose },                     destructuring:
        ...
        //     // module / helper
        //     Optional::new(
        //         modules::import_analysis::import_analyzer(import_interop,
        // ignore_dynamic),         need_analyzer
        //     ),
        ...
        //     ),
        //     Optional::new(fixer(comments.map(|v| v as &dyn Comments)),
        // self.fixer), )
    }
}
